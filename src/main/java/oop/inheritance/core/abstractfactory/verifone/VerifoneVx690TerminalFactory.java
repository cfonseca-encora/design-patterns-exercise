...
public class VerifoneVx690TerminalFactory implements ITerminalFactory {
    private Display display;
    private Keyboard keyboard;
    private static CommunicationDevice communicationDevice;

    private VerifoneVx690TerminalFactory() {}

    public VerifoneVx690TerminalFactory(SupportedTerminal supportedTerminal, CommunicationType communicationType) {
